...
if (document.querySelector('#simp')) {
  ...
  var simp_elem = '';
  simp_elem += '<audio id="audio" preload><source src="" type="audio/mp3"></audio>';
  ...
  simp_elem += '<div class="simp-others flex flex-align"><button type="button" class="simp-plext fa fa-play-circle" title="Auto Play"></button><button type="button" class="simp-random fa fa-random" title="Random"></button><div class="simp-shide"></button></button></div></div>';
